...
# the highest elevation 
	...
	if city2.population >= min_population:
		if city2.population<return_city.population or return_city.population==0:
			return_city = city2
	# Evaluate the 3rd instance to meet the requirements:
	# does city #3 have at least min_population and
	# is its elevation the highest evaluated so far?
	if city3.population >= min_population:
		if city3.population<return_city.population or return_city.population==0:
			return_city = city3
...
# b)An object is a specific instance of a class#######Correcto
