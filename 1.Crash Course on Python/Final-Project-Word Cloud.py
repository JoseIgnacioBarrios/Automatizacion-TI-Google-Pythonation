...
def calculate_frequencies(file_contents):
    ...
    diccionario = {}
    res = file_contents.split()
    for palB in res:
        aux=palB.lower()
        if aux in uninteresting_words:
            pass
        else:
            for lt in aux:
                if lt in punctuations:
                    lt.replace(punctuations,"")
    ...
    cloud.generate_from_frequencies(diccionario)
...
# Definitely check that you passed your frequency count dictionary into the generate_from_frequencies function of wordcloud. 
