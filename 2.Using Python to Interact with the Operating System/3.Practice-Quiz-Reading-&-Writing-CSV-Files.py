...
# The contents_of_file function reads this file into records and returns the information in a nicely formatted block. Fill in the gaps of 
# the contents_of_file function to turn the data in the CSV file into a dictionary using DictReader.
...
# Pregunta 2
 # Using the CSV file of flowers again, fill in the gaps of the contents_of_file function to process the 
...
# Pregunta 3
# In order to use the writerows() function of DictWriter() to write a list of dictionaries to each line
 # of a CSV file, what steps should we take? (Check all that apply)
...
# Correcto
# Awesome! We need to have the exact same amount of variables on the left side of the equals sign as the length of the sequence 
# on the right side when unpacking rows into individual variables.
...
# Correcto
# Great work! Parsing a file means analyzing its contents to correctly structure the data. As long as we know what the data is, 
